...
nationality <- data.frame(
  ...
  col =     c("#ac673e", "#336666",  "#ab3d3f", "#996699", "#e5dbcd",   "#2b2b55", "#b3cccc", "#345284", "#303e6c",  "#afc0d0",  "#9db6c2",       "#708dad",  "#5879a3","#87a1b8"),
  colannot = c('#844F2F', '#bbdddd', '#5a2626', "white", "white",       "#5555aa"   , '#e0ebeb' , '#283F65', '#C9D6D6', '#304E75', '#788C95',       '#2F343B', 'white', '#36404a'),
...
for(lang in colnames(txt)) {
  ...
  #ddd$nationality <- factor(ddd$nationality, levels = nationality$key) 
  ...
  sg <- streamgraph(ddd, nationality, value, year, top = sg_trbl[1], right = sg_trbl[2], bottom = sg_trbl[3], left = sg_trbl[4], height = 570) %>%
 ...
 # sga <- sga %>% sg_annotate(label = txt['descr', lang], x = as.Date("1855-01-01"), y = 2000000, color = 'black', size = "18")
  ...
  sgb <- streamgraph(data.for, group, shareFor, year, 
    ...
    sg_annotate(label = "Share of foreigners in the total population", x = as.Date("1852-01-01"), y = 0.22, color = '#2F343B', size = 15)
